              ...
              <div className="testimonial-slide">
                ...
                >
                  <SwiperSlide className="swiper-slide">
                    ...
                    <p>
                      “A equipe foi incrível! Desenvolveram nosso site com
                      rapidez, entregando um design moderno e funcional. A
                      comunicação foi clara e o resultado superou nossas
                      expectativas. Recomendo muito!”
                    </p>
                    <div className="border-line"></div>
                    <div className="testimonial-info d-flex align-items-center">
                      <img
                        src="/assets/img/bg-img/16.png"
                        alt="Foto do cliente"
                      />
                      <div>
                        <h4>Mariana Silva</h4>
                  ...
                  <SwiperSlide className="swiper-slide">
                    ...
                    <p>
                      “O site ficou perfeito, com design limpo e navegação
                      fluida. A equipe foi super atenciosa, captando exatamente
                      o que precisávamos. O suporte pós-lançamento também é
                      excelente!”
                    </p>
                    <div className="border-line"></div>
                    <div className="testimonial-info d-flex align-items-center">
                  ...
                  <SwiperSlide className="swiper-slide">
                    ...
                    <p>
                      “Contratamos o serviço de SEO e os resultados foram
                      surpreendentes! Nosso site ganhou visibilidade
                      rapidamente, e a equipe nos guiou em cada etapa com muita
                      clareza.”
                    </p>
                    <div className="border-line"></div>
                    <div className="testimonial-info d-flex align-items-center">
