...
const services = [
    { icon: "ads_click", title: "Marketing Digital", description: "Campanhas projetadas para uma experiência digital positiva." },
    { icon: "web", title: "Desenvolvimento", description: "Websites projetados para uma experiência online fluida." },
    { icon: "stream_apps", title: "Aplicativos Móveis", description: "Apps projetados para uma experiência móvel intuitiva." },
    { icon: "design_services", title: "Design UI/UX", description: "Interfaces projetadas para uma experiência visual atrativa." },
    { icon: "ads_click", title: "Marketing Digital", description: "Estratégias projetadas para uma experiência digital impactante." },
    { icon: "web", title: "Desenvolvimento", description: "Plataformas projetadas para uma experiência web acessível." },
    { icon: "stream_apps", title: "Aplicativos Móveis", description: "Aplicativos projetados para uma experiência móvel prática." },
    { icon: "design_services", title: "Design UI/UX", description: "Layouts projetados para uma experiência visual memorável." }
];
