          ...
          <div className="row g-5">
            <div className="col-12 col-lg-6">
              <div className="section-heading">
                <h2 className="mb-0">O Que os Clientes Dizem Sobre Nossos Serviços</h2>
              </div>
            </div>
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="rating-info">
                        ...
                        <div className="company-logo">
                          <img src="/assets/img/bg-img/27.png" alt="Logo da empresa" />
                          <span>|</span>
                          <span>54 Avaliações</span>
                        </div>
                      </div>

                      <p>“Ele entregou rapidamente um design excelente conforme as especificações exigidas. A nova página de destino terá um visual simples e renovado, mantendo o carregamento leve em imagens e, ao mesmo tempo, um aspecto profissional. Além disso, parece muito razoável implementar um design responsivo, então estou muito satisfeito com isso.”</p>
                      <div className="border-line"></div>
                      <div className="testimonial-info d-flex align-items-center">
                        <img src="/assets/img/bg-img/16.png" alt="Foto do cliente" />
                        <div>
