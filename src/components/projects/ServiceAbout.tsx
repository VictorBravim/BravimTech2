          ...
          <div className="row g-4 justify-content-end">
            <div className="col-12 col-md-6">
              <div className="about-us-text-content ps-md-4">
                ...
                <p className="mb-0">
                  Se você perguntar aos nossos clientes como é trabalhar
                  conosco, eles falarão sobre o quanto nos importamos com um
                  relacionamentos verdadeiro para impulsionar o sucesso.
                </p>
                ...
                <ul className="ps-0 list-unstyled mb-0">
                  <li>
                    ...
                    Simplicidade, a Maior Ideia Observada
                  </li>
                  <li>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <li>
                    ...
                    Mantendo Altos Padrões de Publicidade
                  </li>
                </ul>
