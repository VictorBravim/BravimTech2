          ...
          <div className="row g-5">
            <div className="col-12 col-md-6 col-xl">
              <div className="footer-card">
                ...
                <p className="mb-0">
                  Agência de design criativo especializada em soluções visuais
                  inovadoras
                </p>
            ...
            <div className="col-12 col-md-6 col-xl">
              <div className="footer-card">
                ...
                <ul className="footer-nav">
                  ...
                  <li>
                    <a href="#">Design de Aplicativos</a>
                  </li>
                  <li>
                    <a href="#">Desenvolvimento Web</a>
                  </li>
                  <li>
                    <a href="#">Design SaaS</a>
                  </li>
                  <li>
                    <a href="#">Design Webflow</a>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="col-12 col-md-6 col-xl-4">
              <div className="footer-card">
                <h5 className="mb-0">Inscreva-se</h5>
